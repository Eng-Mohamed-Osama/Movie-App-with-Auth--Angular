...
export class MovieDetailsComponent implements OnInit {
  ...
  rating:number;
  releaseDate:object;
  MoviesJson=JSON.stringify( [
    {
      "id": 1,
      "original_language": "en",
      "overview": "Tom the cat and Jerry the mouse get kicked out of their home and relocate to a fancy New York hotel, where a scrappy employee named Kayla will lose her job if she can’t evict Jerry before a high-class wedding at the hotel. Her solution? Hiring Tom to get rid of the pesky mouse.",
      "popularity": 4213.261,
      "poster_path": "https://image.tmdb.org/t/p/w342/6KErczPBROQty7QoIsaa6wJYXZi.jpg",
    ...
    },
    {
      ...
      "popularity": 839.678,
      "poster_path": "https://image.tmdb.org/t/p/w342/sCoG0ibohbPrnyomtzegSuBL40L.jpg",
    ...
    },
    {
      ...
      "popularity": 839.678,
      "poster_path": "https://image.tmdb.org/t/p/w342/hm58Jw4Lw8OIeECIq5qyPYhAeRJ.jpg",
      "release_date": "2021-02-22",
      "title": "Soul",
      "vote_average":8.3,
      "vote_count": 5000
    },
    {
      ...
      "popularity": 839.678,
      "poster_path": "https://image.tmdb.org/t/p/w342/lPsD10PP4rgUGiGR4CCXA6iY0QQ.jpg",
    ...
    },
    {
      ...
      "popularity": 839.678,
      "poster_path": "https://image.tmdb.org/t/p/w342/sKCr78MXSLixwmZ8DyJLrpMsd15.jpg",
  ...
  MovieList:Array<any> = JSON.parse(this.MoviesJson)
  constructor(private activated : ActivatedRoute) { 
    this.activated.params.subscribe(params => this.MovieList.some((el:any) => {
      console.log(params , el)
      if(el.id == params.id){
      this.dtails = el.overview;
      this.title = el.title;
      this.ImgSrc =el.poster_path;
      this.rating = el.vote_average;
      this.releaseDate = el.release_date;
      this.lang = el.original_language;
    }}))
